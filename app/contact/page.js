        ...
        <main className="container mx-auto px-4 py-6">
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-lg">
                <div className="flex items-center mb-4">
                    ...
                    <input type="text" name="name" onChange={handleInput} id="name" value={inputs.name??""} className="border rounded px-2 py-1 w-2/4" />
                </div>
                <div className="flex items-center mb-4">
                    <label htmlFor="email" className="w-1/4">Email:</label>
                    <input type="email" name="email" onChange={handleInput} id="email" value={inputs.email??""} className="border rounded px-2 py-1 w-2/4" />
                </div>
                <div className="flex items-center mb-4">
